...
@echo _TARGET	equ	_PROFI>target.inc
call make_zx.bat
...
tools\trdtool # out\profi_fdisk.scl
tools\trdtool + out\profi_fdisk.scl out\boot.$b
tools\trdtool + out\profi_fdisk.scl out\fdisk.bin.mlz
tools\monoscl out\profi_fdisk.scl
tools\trdtool + out\profi_fdisk.scl out\nemoide.drv
tools\trdtool + out\profi_fdisk.scl out\ni_lba48.drv
tools\trdtool + out\profi_fdisk.scl out\profiide.drv
tools\trdtool + out\profi_fdisk.scl out\readme.txt
tools\trdtool + out\profi_fdisk.scl history.txt
if errorlevel 1 goto ERR
